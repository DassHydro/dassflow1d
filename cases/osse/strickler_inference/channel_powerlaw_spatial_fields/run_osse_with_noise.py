...
def run_osse():
    ...
    # Perturb heights observations with unbiased gaussian noise with sigma = 1cm
    # REMARK first row in obs.obs are height values, 2nd row are width values
    obs.obs[0, :] += np.random.normal(loc=0.0, scale=0.01)
    print("")
